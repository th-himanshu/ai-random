...
import { service1, gradient, recording03, recording01, disc02, chromecast, sliders04 } from "../assets";
                ...
                <div className="relative">
                    <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-white/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                        <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
                            <img className="w-full h-full object-cover opacity-50 sm:opacity-50 md:opacity-100 md:object-right" width={800} alt="" height={730} src={service1} />
                        </div>
                    ...
                    <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                        ...
                        <div className="p-4 bg-[#15131D] rounded-3xl overflow-hidden lg:min-h-[46rem]">
                            ...
                            <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                                {/* <img src={service3} className="w-full h-full object-cover opacity-70" width={520} height={400} alt="" /> */}
